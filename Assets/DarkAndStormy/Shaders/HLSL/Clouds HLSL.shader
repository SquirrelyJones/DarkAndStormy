        ...
        SubShader
        {
            ...
            Pass
            {
                ...
                v2f vert (appdata_full v)
                {
                    ...
                    o.vertex = vertexPositions.positionCS;
                ...
                half4 frag (v2f IN) : SV_Target
                {
                    ...
                    float lightDot = saturate( dot( _MainLightPosition, viewDir ) * 0.5 + 0.5 );

                    half3 lightTrans = _MainLightColor.rgb * ( pow(lightDot,_LightSpread.x) * _LightSpread.y + pow(lightDot,_LightSpread.z) * _LightSpread.w );
